...
```bash
curl -L -O "https://github.com/g5ostXa/ghostshell/releases/download/v0.1.2-1/ghostshell-v0.1.2-1-linux-amd64"
curl -L -O "https://github.com/g5ostXa/ghostshell/releases/download/v0.1.2-1/sha256sum.txt"
```
...
```
ghostshell-v0.1.2-1-linux-amd64: OK
```
Make sure the binary is executable:
```bash
chmod +x ghostshell-v0.1.2-1-linux-amd64
```
Move the binary in your `$GOBIN` as `ghostshell`:
```bash
mv ./ghostshell-v0.1.2-1-linux-amd64 "$GOBIN/ghostshell"
```
#### Using git
